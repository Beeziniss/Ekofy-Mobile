...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResultType<T>);
}
...
/// @nodoc
class $ResultTypeCopyWith<T,$Res>  {
$ResultTypeCopyWith(ResultType<T> _, $Res Function(ResultType<T>) __);
}


/// Adds pattern-matching-related methods to [ResultType].
extension ResultTypePatterns<T> on ResultType<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ResultTypeCopyWith<T, $Res> {
...
@override
String toString() {
  return 'ResultType<$T>.failure(message: $message, statusCode: $statusCode)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ResultTypeCopyWith<T, $Res> {
